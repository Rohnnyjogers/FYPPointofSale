...
export const writeNfc = async(
    ...
    const receiptDate: Date = new Date(currentDate.getFullYear(),currentDate.getMonth()-1,currentDate.getDate()-2,currentDate.getHours(),currentDate.getMinutes(),currentDate.getSeconds());
